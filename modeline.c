...
void general_timing_formula(double HRes, double VRes, double Clock, double Flags, struct modeline *modeline)
{
    ...
    if (Flags > 0)  // if interlace mode
    {
        ...
        modeline->pixel_clock = (int) PClock;
        modeline->h_display = (int) HRes;
        modeline->h_sync_start = (int) (HTotal - HBackPorch - HSyncWidth);
        modeline->h_sync_end = (int) (HTotal - HBackPorch);
        modeline->h_total = (int) HTotal;
        modeline->v_display = (int) (VRes * 2.0);
        modeline->v_sync_start = (int) ((VTotal - VSyncPlusBackPorch) * 2.0);
        modeline->v_sync_end = (int) ((VTotal - VBackPorch) * 2.0);
        modeline->v_total = (int) (VTotal * 2.0);
    }
    else if (Flags < 0)  // if doublescan mode
    {
    ...
    else
    {
        ...
        modeline->h_sync_end = (int) (HTotal - HBackPorch);
        modeline->h_total = (int) HTotal;
        modeline->v_display = (int) VRes;
        modeline->v_sync_start = (int) (VTotal - VSyncPlusBackPorch);
        modeline->v_sync_end = (int) (VTotal - VBackPorch);
        modeline->v_total = (int) VTotal;
    }
